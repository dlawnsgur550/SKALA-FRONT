...
<p align="center">
  <img src="docs/images/01-main.png" alt="SKALA-FRONT 메인 화면" width="750">
</p>
...
- 코스별 사진 5장을 넘길 수 있는 Carousel
- `<dialog>`를 이용한 상세 게시글 표시

<p align="center">
  <img src="media/walk-asakusa01-sensoji.jpg" alt="아사쿠사 산책 코스" width="250">
...
│   ├── disneysea.jpeg
│   ├── music.mp3
│   ├── walk-asakusa01-sensoji.jpg
│   ├── walk-asakusa02-nakamichi.jpg
│   ├── walk-asakusa03-bunkakankou.jpg
│   ├── walk-asakusa04-riverwalk.jpg
│   ├── walk-asakusa05-skytree.jpg
│   ├── tokyo-station.jpeg
│   ├── video.mp4
...
<small>
<strong>LLM 활용</strong><br>
기능 구현 아이디어와 코드 초안 작성에 LLM을 참고했습니다.<br>
생성된 코드는 직접 실행·수정하고 주요 JavaScript와 CSS 구조를 확인했습니다.
</small>
